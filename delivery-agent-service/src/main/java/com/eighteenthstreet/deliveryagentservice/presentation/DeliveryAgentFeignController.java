...
public class DeliveryAgentFeignController {
	...
	public ResponseEntity<List<DeliveryAgentDto>> getDeliveryAgentsByDeliveryId(
		@PathVariable("deliveryId") UUID deliveryId) {
		return ResponseEntity.ok(deliveryAgentService.getDeliveryAgentsByDeliveryId(deliveryId));
	}
